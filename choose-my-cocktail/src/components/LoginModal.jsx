...
const LoginModal = ({ isOpen, onClose, onSwitchToRegister }) => {
  const { login, loginWithOAuth, resendVerificationEmail } = useAuth();
              ...
              <div className="mt-2">
                <button
                  ...
                  className={`text-xs underline font-bold ${
                    resendCooldown > 0 ? 'text-gray-500 cursor-not-allowed' : 'text-red-800 hover:text-red-900'
                  }`}
                >
                  {resendCooldown > 0
